...
export default function Home() {
  ...
  // MISE À JOUR DES CATÉGORIES POUR MIHI.CARE
  const categories = [
    { title: "VISAGE", desc: "Soins ciblés et innovants.", link: "#", img: "https://i.postimg.cc/7b74HyHm/Aloe-via.jpg" }, // On pourra changer les images plus tard
    { title: "CORPS", desc: "Hygiène et nutrition de la peau.", link: "#", img: "https://i.postimg.cc/s1SzjRjT/Lifetakt.jpg" },
    { title: "MAQUILLAGE", desc: "Sublimez votre beauté naturelle.", link: "#", img: "https://i.postimg.cc/Hj5mYCY3/Esthetique.jpg" },
    { title: "MAISON", desc: "Entretien écologique & efficace.", link: "#", img: "https://i.postimg.cc/xqHQfSfP/Regime.jpg" },
    { title: "PARFUMS", desc: "Fragrances haut de gamme.", link: "#", img: "https://i.postimg.cc/3Wph8H8C/Parfums.jpg" },
    { title: "BIEN-ÊTRE", desc: "Suppléments et huiles.", link: "#", img: "https://i.postimg.cc/py8vWtWJ/Catalogue.jpg" },
    { title: "CHEVEUX", desc: "Force et brillance au quotidien.", link: "#", img: "https://i.postimg.cc/23vYkfkd/Promotions.jpg" },
    { title: "PROMOTIONS", desc: "Vos offres Mihi du moment.", link: "#", img: "https://i.postimg.cc/hhxnDqDL/E-commerce.jpg" }
  ];

  return (
    <div className="flex min-h-screen flex-col bg-white font-['Poppins'] text-slate-900">
      ...
      <header className="w-full py-4 px-6 flex justify-between items-center bg-white sticky top-0 z-[100] shadow-sm border-b border-slate-50">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            <span className="text-2xl font-black tracking-tighter text-[#1b4332]">MIHI</span>
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link href="#" className="text-[11px] font-bold uppercase tracking-widest text-slate-500 hover:text-[#FF8C69] transition-all">Catalogue</Link>
          <Link href="#" className="text-[11px] font-bold uppercase tracking-widest text-slate-500 hover:text-[#FF8C69] transition-all">Produits</Link>
        ...
        <button onClick={() => setShowMobileMenu(!showMobileMenu)} className="md:hidden p-2">
           <div className="w-6 h-0.5 bg-[#1b4332] mb-1"></div>
           <div className="w-6 h-0.5 bg-[#1b4332]"></div>
        </button>
      </header>

      <main className="flex-1">
        {/* HERO SECTION - Inspirée de Mihi.care */}
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto">
          <div className="flex justify-between items-end mb-16">
            <div>
              ...
              <div className="w-12 h-1 bg-[#FF8C69] mt-2"></div>
            </div>
            <p className="hidden md:block text-slate-400 font-medium text-sm">Explorez toutes nos gammes Mihi</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {categories.map((cat, i) => (
              <div key={i} className="group cursor-pointer">
                ...
                <h3 className="text-lg font-black text-[#1b4332] mb-1">{cat.title}</h3>
                <p className="text-xs text-slate-400 font-bold uppercase tracking-wider">{cat.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="py-20 px-6 mx-4 my-12 bg-[#1b4332] rounded-[3rem] text-white relative overflow-hidden text-center">
           ...
           <div className="absolute top-0 right-0 w-64 h-64 bg-emerald-800 rounded-full blur-[100px] opacity-50 -mr-32 -mt-32"></div>
        </section>
      </main>
